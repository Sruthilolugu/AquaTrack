...
# Paths
model_path = os.path.join(BASE_DIR, "models", "/Users/sruthiuma/Desktop/PrototypeSIH/models/best_model 2.pkl")
dataset_path = os.path.join(BASE_DIR, "dataset", "/Users/sruthiuma/Desktop/PrototypeSIH/dataset/monsoon_cleaned.csv")
